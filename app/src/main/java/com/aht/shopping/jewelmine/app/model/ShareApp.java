package com.aht.shopping.jewelmine.app.model;
...
public class ShareApp {
    ...
    public void shareText(Activity activity, String message) {
        ...
        sharingIntent.putExtra(Intent.EXTRA_SUBJECT, "Sharing Love Test App");
    ...
    public boolean shareReport(Activity activity, View view, String message) {
        ...
        try {
            ...
            if (isExternalStorageWritable()) {
                ...
                sharingIntent.putExtra(Intent.EXTRA_SUBJECT, "Sharing Love Test Report");
